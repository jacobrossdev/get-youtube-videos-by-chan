...
class Youtube
{
     ...
     * @throws \Exception
     */
    public function getPlaylistItemsByPlaylistId($playlistId, $params, $maxResults = 50, $pageInfo = false)
    {
        ...
        $data = $this->getPlaylistItemsByPlaylistIdAdvanced($params, $pageInfo);
